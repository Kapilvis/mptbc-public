...
const schema = validation.create<Master.ClassForm>((o) => ({
  name: o
    .string()
    .required()
...
export function useClassForm(
  submitCallback: Forms.SubmitFunc<Master.ClassForm>,
  defaultValues?: Forms.FetchDataFunc<Master.ClassForm>,
) {
  const form = useAppForm<Master.ClassForm>({
