...
const schema = validation.create<Master.DepotForm>((o) => ({
  name: o
    .string()
    .required()
...
export function useDepotForm(
  submitCallback: Forms.SubmitFunc<Master.DepotForm>,
  defaultValues?: Forms.FetchDataFunc<Master.DepotForm>,
) {
  const form = useAppForm<Master.DepotForm>({
