...
export const mockDashboardData = {
  ...
  printerProfile: {
    ...
    currentCapacity: "3,90,000 Books",
  ...
  printingProgress: {
    ...
    totalBooksTarget: "3,90,000 Books",
    dispatchCount: "1,80,500 Books",
    pending: "2,09,500 Books",
