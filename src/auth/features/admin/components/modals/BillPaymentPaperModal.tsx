...
type Item = (typeof mockDashboardData.billAndPayment.paper.details)[number];

export const BillPaymentPaperModal: React.FC<Props> = ({ visible, onHide }) => {
  ...
  return (
    <Modal
      visible={visible}
      onHide={onHide}
      header="Bill & Payment Details - Paper"
      size="large"
    >
      <Grid
        data={mockDashboardData.billAndPayment.paper.details}
        columns={columns}
      />
    </Modal>
  );
