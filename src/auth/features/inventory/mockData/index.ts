...
const initialDistributions = (): PaperDistribution[] => [
  ...
  {
    distributionNo: "DIS-2026-009",
    distributionDate: "2026-08-20",
    printer: "Central Cover Printers Bhopal",
    orderNo: "ORD-2026-009",
    gsm: 250,
    paperType: "Cover Paper",
    availableStockAtIssue: 227,
    approvedQty: 170,
    previouslySupplied: 0,
    pendingQty: 25,
    issueQuantity: 145,
    vehicleNo: "MP04HA1122",
...
if (!localStorage.getItem("central_depot_data_v29")) {
  ...
  localStorage.setItem("central_depot_data_v29", "true");
